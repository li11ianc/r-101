...
I created mammal-sleep.csv using the `write_csv()` function, as in `write_csv(msleep, "data/mammal-sleep.csv)`.
...
add option color = in the geom_histogram argument (or in aes!) now try fill=
may need to filter NAs!!!
...
name_of_function <- function(input1=DEFAULT_VALUE, input2) {
    what the function does will do in here!!
}
